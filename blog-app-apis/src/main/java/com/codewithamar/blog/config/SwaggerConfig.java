...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Rest APIs",
				"This project is developed by Amrendra ", "1.0", "Terms of Service",
				new Contact("Amrendra", "https://learncodewithdurgesh.com", "singhroshan276@gmail.com"),
